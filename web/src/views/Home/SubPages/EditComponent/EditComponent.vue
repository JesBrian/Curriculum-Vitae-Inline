<template>
  <div style="width: 100%; height: 100%;">
    <PathNavbar>
      <BreadcrumbItem>
        <Icon type="ios-clipboard" /> 创建组件
      </BreadcrumbItem>
    </PathNavbar>

    <div style="width: 100%; height: 100%; padding:8px 18px 68px 38px; position:relative;">
      <Layout style="width: 100%; height: 100%; position: relative; box-sizing: border-box;">
...
<script>
  ...
  export default {
    ...
    components: {
      PathNavbar, DraggableResizableCell, InputTag
    },
